...
private extension String {
    ...
    static let allNameButtonLabel = "Все имена"
}
...
final class MeowleSearchCatPage: BasePage {
    ...
    private lazy var allNameButton = app.buttons[.allNameButtonLabel]
    
    // MARK: - Actions
    
    // Тап по кнопке "Все имена"
    @discardableResult
    func tapAllNameButton() -> MeowleSearchCatPage {
        allNameButton.tap()
        return self
    }
